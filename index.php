...
if(isset($_POST['submit'])){
    ...
    $query   ="SELECT * FROM customer WHERE customer_email   = '$email' AND
          ...
          if(!empty($login['customer_id'])){
            $_SESSION['id']=$login['customer_id'];
            $_SESSION['name']=$login['customer_name'];
            $_SESSION['phone']=$login['customer_phone'];
            $_SESSION['email']=$login['customer_email'];
            $_SESSION['address']=$login['customer_address'];
            $_SESSION['image']=$login['customer_image'];
