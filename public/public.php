        ...
        while($cat = mysqli_fetch_assoc($result)){
         echo"<div class='row justify-content-center '>
          <div class='col-4' style='display:inline;'>
              ...
              <a href='shop.php?id={$cat['category_id']}' class='product-item md-height bg-gray d-block' ><span style='font-size:20px; font-weight:bold;'>{$cat['category_name']}</span><img src='$path{$cat['category_image']}' alt='Image' class='img-fluid'></a>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            ...
            <h2 class="item-title">Blue Shoe High Heels</h2>
            <div class="star-rating">
              <span class="icon-star2 text-warning"></span>
              <span class="icon-star2 text-warning"></span>
              <span class="icon-star2 text-warning"></span>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            ...
            <h2 class="item-title">Denim Jacket</h2>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            ...
            <h2 class="item-title">Leather Green Bag</h2>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            ...
            <h2 class="item-title">Smooth Cloth</h2>
            <div class="star-rating">
              <span class="icon-star2 text-warning"></span>
              <span class="icon-star2 text-warning"></span>
              <span class="icon-star2 text-warning"></span>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            ...
            <h2 class="item-title">Yellow Jacket</h2>
            <div class="star-rating">
              <span class="icon-star2 text-warning"></span>
              <span class="icon-star2 text-warning"></span>
              <span class="icon-star2 text-warning"></span>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 ml-auto order-md-2 align-self-start">
            ...
            <h2 class="sub-title">#New Summer Collection 2019</h2>
            <h1>New Shoes</h1>
            <p><a href="shop.php?id=18" class="btn btn-black rounded-0">Shop Now</a></p>
            </div>
          </div>
          <div class="col-md-6 order-1 align-self-end">
