...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="site-navbar bg-white py-2">
     ...
     <?php
            $query1  = "SELECT * FROM product WHERE product.product_id = {$_GET['id']}";
    ...
    echo"<div class='bg-light py-3'>
      <div class='container'>
        <div class='row'>
          <div class='col-md-12 mb-0'><a href='public.php'>Home</a> <span class='mx-2 mb-0'>/</span> <a href='shop.php'>Shop</a> <span class='mx-2 mb-0'>/</span> <strong class='text-black'>{$det['product_name']}</strong></div>
        </div>
      </div>
    </div>  
      ...
      <div class='container'>
        <div class='row'>
          <div class='col-md-6'>
            <div class='item-entry'>
              <a href='#' class='product-item md-height bg-gray d-block'>
                <img src='$path{$det['product_image']}' alt='Image' class='img-fluid'>
              </a>
          ...
          <div class='col-md-6'>
            ...
            <h2 class='text-black'>{$det['product_name']}</h2>
            <p>{$det['product_desc']}</p>
            

            <p><strong class='text-primary h4'>{$det['product_price']}<span>$</span></strong></p>
            ...
            echo "<form action='cart.php?id={$det['product_id']}' method='post'>";
            echo"<button  type='submit' name='addcart' class='buy-now btn btn-sm height-auto px-4 py-3 btn-primary'> Add To Cart</button>
             </form>
          </div>
        </div>
      </div>
