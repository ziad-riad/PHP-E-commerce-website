...
$quantity= $qty;
$orddate = date("y-m-d");
$query = "INSERT INTO orders (order_date,product_id,customer_id,total,qty) VALUES ('$orddate','$x','$cust_id','$totalall','$quantity')";
...
<html lang="en">
  ...
  <div class="site-wrap">
            ...
            <ul>
             <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                ...
                                <a class="dropdown-item" href="checkin/logout.php"><i class="fas fa-power-off mr-2"></i>Logout</a>
                            </div>
                        </li>
           </ul>             
          </div>
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="public.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Thank You</strong></div>
        </div>
      </div>
    </div>  
